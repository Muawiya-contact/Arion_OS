...
BootPromptWindow::QuitRequested()
{
	...
	BAlert* alert = new(std::nothrow) BAlert(
		B_TRANSLATE_SYSTEM_NAME("Quit Arion OS"),
...
{
	BString titleTextHaiku = B_TRANSLATE("Welcome to Arion OS!");
	BString mainTextHaiku = B_TRANSLATE_COMMENT(
		"Thank you for trying out Arion OS! We hope you'll like it!\n\n"
		"Please select your preferred language and keymap. Both settings can "
		"also be changed later when running Arion OS.\n\n"

		"Do you wish to install Arion OS now, or try it out first?",
		...
		"<www.haiku-os.org>.\"");
	BString desktopTextHaiku = B_TRANSLATE("Try Arion OS");
	BString installTextHaiku = B_TRANSLATE("Install Arion OS");
	...
	BString mainTextDebranded = B_TRANSLATE_COMMENT(
			...
			"This notice appears when the build of Arion OS that's currently "
			"being used is unofficial, as in, not distributed by Arion itself."
			"For other languages, a note could be added: \""
			"Note: Localization of Arion applications and other components is "
			"an on-going effort. You will frequently encounter untranslated "
			"strings, but if you like, you can join in the work at "
			"<www.haiku-os.org>.\"");
