...
AboutWindow::AboutWindow()
	...
	BWindow(BRect(0, 0, kWindowWidth, kWindowHeight),
		B_TRANSLATE("About Arion OS"), B_TITLED_WINDOW,
...
AboutView::_CreateCreditsView()
{
	...
	BString text;
	text.SetToFormat(
		B_TRANSLATE(COPYRIGHT_STRING "2001-%" B_PRId32 " The Arion project. "),
		year);
	...
	fCreditsView->SetFontAndColor(be_plain_font, B_FONT_ALL, &fTextColor);
	fCreditsView->Insert(B_TRANSLATE("The copyright to the Arion code is "
		"property of Arion, Inc. or of the respective authors where expressly "
		"noted in the source. Arion" B_UTF8_REGISTERED
		" and the ARION logo" B_UTF8_REGISTERED
		" are registered trademarks of Arion, Inc."
		"\n\n"));

	fCreditsView->SetFontAndColor(be_plain_font, B_FONT_ALL, &fLinkColor);
	fCreditsView->InsertHyperText(B_TRANSLATE("Visit the Arion website"),
